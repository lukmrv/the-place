...
export const christmas_tree: Pattern = [
	// Star
	{ x: 3, y: 0, color: 'yellow' },
	// Tree layers
	{ x: 2, y: 1, color: 'darkGreen' },
	{ x: 3, y: 1, color: 'darkGreen' },
	{ x: 4, y: 1, color: 'darkGreen' },
	{ x: 1, y: 2, color: 'darkGreen' },
	{ x: 2, y: 2, color: 'darkGreen' },
	{ x: 3, y: 2, color: 'darkGreen' },
	{ x: 4, y: 2, color: 'darkGreen' },
	{ x: 5, y: 2, color: 'darkGreen' },
	{ x: 0, y: 3, color: 'darkGreen' },
	{ x: 1, y: 3, color: 'darkGreen' },
	{ x: 2, y: 3, color: 'darkGreen' },
	{ x: 3, y: 3, color: 'darkGreen' },
	{ x: 4, y: 3, color: 'darkGreen' },
	{ x: 5, y: 3, color: 'darkGreen' },
	{ x: 6, y: 3, color: 'darkGreen' },
	// Trunk
	{ x: 3, y: 4, color: 'brown' },
	{ x: 3, y: 5, color: 'brown' }
];

export const infakt_logo: Pattern = [
	// Vertical line
	{ x: 1, y: 0, color: 'blue' },
	{ x: 1, y: 1, color: 'blue' },
	{ x: 1, y: 2, color: 'blue' },
...
export const mario: Pattern = [
	...
	{ x: 3, y: 1, color: 'brown' },
	{ x: 4, y: 1, color: 'brown' },
	{ x: 3, y: 1, color: 'black' }, // eye
	{ x: 2, y: 1, color: 'brown' }, // mustache
	{ x: 4, y: 1, color: 'brown' }, // mustache
	// Body
	{ x: 2, y: 2, color: 'red' },
	{ x: 3, y: 2, color: 'red' },
	{ x: 4, y: 2, color: 'red' },
...
export const sword: Pattern = [
	...
	// Blade
	{ x: 3, y: 3, color: 'lightGray' },
	{ x: 3, y: 4, color: 'lightGray' },
	{ x: 3, y: 5, color: 'lightGray' },
	{ x: 3, y: 6, color: 'lightGray' }
];

export const cross: Pattern = [
	{ x: 0, y: 0, color: 'white' },
	{ x: 1, y: 0, color: 'blue' },
