const AMOGUS_PATTERN = [
  ...
  { x: 0, y: 4, color: null },
  { x: 2, y: 4, color: null },
  { x: -1, y: 1, color: [36, 80, 164, 255] },
  { x: -1, y: 2, color: [36, 80, 164, 255] },
];
...
// null for selected pixel color
// const TREE_PATTERN_OUTLINE_COLOR = null;
// const TREE_TRUNK_COLOR = null;
// const LEAVES_SHADE_1 = null;
// const LEAVES_SHADE_2 = null;
// const LEAVES_SHADE_3 = null;
const TREE_PATTERN_OUTLINE_COLOR = [0, 0, 0, 255];
const TREE_TRUNK_COLOR = [156, 105, 38, 255];
// autumn leaves colors
// const LEAVES_SHADE_1 = [255, 214, 53, 255];
// const LEAVES_SHADE_2 = [255, 168, 0, 255];
// const LEAVES_SHADE_3 = [255, 69, 0, 255];
// summer leaves colors
// const LEAVES_SHADE_1 = [126, 237, 86, 100];
// const LEAVES_SHADE_2 = [126, 237, 86, 255];
// const LEAVES_SHADE_3 = [0, 163, 104, 255];
// alien leaves colors
const LEAVES_SHADE_1 = [255, 153, 170, 255];
const LEAVES_SHADE_2 = [180, 74, 192, 255];
const LEAVES_SHADE_3 = [129, 30, 159, 255];
const TREE_PATTERN = [
  // // // // // //
  // outline (black)
  // // // // // //
